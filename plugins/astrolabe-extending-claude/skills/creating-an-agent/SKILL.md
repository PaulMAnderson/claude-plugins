...
description: Create specialized subagents: descriptions, tool selection, and testing
user-invocable: false
---

# Creating an Agent

**REQUIRED BACKGROUND:** Read astrolabe-extending-claude:writing-claude-directives for foundational guidance on token efficiency, compliance techniques, and directive structure. This skill focuses on agent-specific patterns.
