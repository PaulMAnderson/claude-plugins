...
**REQUIRED SUB-SKILL:** Use rpi-house-style:howto-code-in-typescript for general TypeScript patterns. This skill covers React-specific TypeScript usage only.
