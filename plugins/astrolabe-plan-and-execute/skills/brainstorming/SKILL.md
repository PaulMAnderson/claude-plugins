---
name: brainstorming
description: Before writing code - refine rough ideas into designs through structured questioning
...
**Use @agent-astrolabe-research-agents:internet-researcher when available. Otherwise use WebSearch/WebFetch aggressively.**
