...
description: Complete a development branch: structured merge, PR, or cleanup options
...
Before merging or creating a PR, invoke `astrolabe-extending-claude:project-claude-librarian` to update CLAUDE.md files if contracts or structure changed.
...
**If librarian subagent is not available:** skip this step, saying aloud that you're skipping it because the `astrolabe-extending-claude` plugin is not available.
