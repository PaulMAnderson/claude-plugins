...
**Save plans to:** `.astrolabe/docs/implementation-plans/YYYY-MM-DD-<feature-name>/phase_##.md`
...
Read `plugins/astrolabe-plan-and-execute/skills/writing-implementation-plans/REFERENCE.md` for:
