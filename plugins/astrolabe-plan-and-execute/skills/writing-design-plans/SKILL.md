...
**File location:** `.astrolabe/docs/design-plans/YYYY-MM-DD-<topic>.md`

The file is created by starting-a-design-plan Phase 3. This skill appends to that file.

**Expected naming convention:**
- Good: `.astrolabe/docs/design-plans/2025-01-18-oauth2-svc-authn.md`
...
Read `plugins/astrolabe-plan-and-execute/skills/writing-design-plans/REFERENCE.md` for:
