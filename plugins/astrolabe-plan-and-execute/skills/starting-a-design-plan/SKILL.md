...
- (conditional) Read project design guidance (if `.astrolabe/design-plan-guidance.md` exists)
...
- Phase 5: Design Documentation (design written to .astrolabe/docs/design-plans/)
...
**Check if `.astrolabe/design-plan-guidance.md` exists:**

Use the Read tool to check if `.astrolabe/design-plan-guidance.md` exists in the session's working directory.

**If the file exists:**

1. Use TaskCreate to add: "Read project design guidance from [absolute path to .astrolabe/design-plan-guidance.md]"
...
**REQUIRED SUB-SKILL:** Use astrolabe-plan-and-execute:asking-clarifying-questions
...
**File location:** `.astrolabe/docs/design-plans/YYYY-MM-DD-{slug}.md`
...
**REQUIRED SUB-SKILL:** Use astrolabe-plan-and-execute:brainstorming
...
**REQUIRED SUB-SKILL:** Use astrolabe-plan-and-execute:writing-design-plans
...
The skill will write a structured summary to `.astrolabe/CONTEXT.md`. This file persists
...
```
Design complete! Design document committed to `.astrolabe/docs/design-plans/[filename]`.
...
```
/astrolabe-plan-and-execute:start-implementation-plan @.astrolabe/docs/design-plans/[full-filename].md .
```
