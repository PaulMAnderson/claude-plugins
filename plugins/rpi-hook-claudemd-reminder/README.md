...
- **rpi-extending-claude:project-claude-librarian** - The agent that reviews changes and updates CLAUDE.md files
- **rpi-extending-claude:maintaining-project-context** - The skill that defines when and how to update documentation

## Installation

Install via rpi-plugins.
