---
name: "astrolabe-debug"
description: "Diagnose unexpected behavior, failing tests, builds, or integrations using root-cause investigation and hypothesis-driven regression fixes in the Astrolabe workflow."
---
...
6. Use [astrolabe-review](../astrolabe-review/SKILL.md) for material fixes and [astrolabe-context](../astrolabe-context/SKILL.md) for ongoing work. Report root cause, change, observed evidence, and remaining uncertainty. If the environment prevents reproduction, describe what is and is not verified; do not manufacture a passing result.
