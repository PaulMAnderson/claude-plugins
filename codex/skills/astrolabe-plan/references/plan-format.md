...
Use the following structure with concrete project values. `phase_1.md` from existing Astrolabe plans is also acceptable; preserve numbering and resolve dependencies numerically. Do not silently overwrite existing phase files.
...
files-required:
  - .astrolabe/docs/design-plans/YYYY-MM-DD-feature.md
