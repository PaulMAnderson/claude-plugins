...
Use `docs/design-plans/YYYY-MM-DD-<slug>.md`. Fill every applicable section with actual project facts; omit irrelevant sections. The tier index helps later context selection without discarding binding details.
