...
**REQUIRED BACKGROUND:** Read rpi-extending-claude:writing-claude-directives for foundational guidance on token efficiency, discovery optimization, and compliance techniques. This skill focuses on TDD methodology specific to skill creation.
...
**REQUIRED:** Use rpi-extending-claude:testing-skills-with-subagents for complete methodology.
