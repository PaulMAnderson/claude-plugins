...
description: Dispatch code-reviewer subagent; manage review-fix loop until zero issues
user-invocable: false
---

# Requesting Code Review

Dispatch astrolabe-plan-and-execute:code-reviewer subagent to catch issues before they cascade.
...
```bash
[extension scripts dir]/review-package "$BASE_SHA" "$HEAD_SHA"   # prints the file path
```
