# Writing Design Plans — Reference

Detailed guidance, examples, and process steps.
Read specific sections when SKILL.md directs you to them.
...
Present generated criteria to the user. Use ask_user: "Review the acceptance criteria. Approve to continue, or describe what's missing or needs revision."
...
Use the subagent tool to generate Summary and Glossary:
...
```bash
git add .astrolabe/docs/design-plans/YYYY-MM-DD-<topic>.md
...
"Design plan documented in `.astrolabe/docs/design-plans/YYYY-MM-DD-<topic>.md` and committed."
