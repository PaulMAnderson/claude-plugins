#!/usr/bin/env python3
"""
AfterTool hook that reminds to invoke project-claude-librarian
...
# Only process run_shell_command tool
    ...
    output = {
        ...
        "hookSpecificOutput": {
            "additionalContext": (
                ...
                "(astrolabe-extending-claude:project-claude-librarian) to review and update "
