...
Run RED-phase tests at the model level you expect in production. If the skill will primarily be used by Sonnet agents, test with `astrolabe-basic-agents:sonnet-general-purpose`. If you're unsure which model users will run, use ask_user to ask — recommend Sonnet as the default.
