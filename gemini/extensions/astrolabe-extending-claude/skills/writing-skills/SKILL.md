---
name: writing-skills
description: Create or edit skills with subagent TDD testing before deployment
user-invocable: false
---

# Writing Skills

**REQUIRED BACKGROUND:** Read astrolabe-extending-claude:writing-claude-directives for foundational guidance on token efficiency, discovery optimization, and compliance techniques. This skill focuses on TDD methodology specific to skill creation.
...
**REQUIRED:** Use astrolabe-extending-claude:testing-skills-with-subagents for complete methodology.
